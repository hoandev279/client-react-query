...
```     
  ...
  2. Create Home Page to Learn props, state and useEffect           
    - Router configuration.       
    - Create Components       
      + Products      
      + ProductsCard     
    - Use props, state and useEffect to getProducts.       

  3. Create ProductDetail Page       
    - Router configuration.        
    - Create Components         
      + ProductInfo      
    - Use props, state and useEffect to getOneProduct.          
